...
df = pd.read_excel('C:/Users/jisnu/Desktop/jisnu/data/fl_quote.xlsx', nrows = 37600)
...
"""
	...
	JOIN employee AS e
	WHERE e.sub_code = q.sub_producer
""")
